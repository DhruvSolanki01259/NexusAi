...
export const metadata = {
  title: "Memory | NEXUS AI",
  description:
    "Learn how memory works in NEXUS AI, including short-term memory, long-term memory, summarization, and checkpointing.",
};

export default function MemoryPage() {
  const filePath = path.join(process.cwd(), "content", "blogs", "memory.md");
        ...
        <div className="relative mx-auto max-w-5xl px-6 py-24 lg:px-8 lg:py-32">
          <div className="max-w-3xl">
            ...
            <h1 className="mt-7 text-4xl font-semibold tracking-[-0.04em] text-[#edf5fc] sm:text-5xl lg:text-6xl">
              How NEXUS AI
              <span className="block text-[#23ce6b]">remembers.</span>
            </h1>

            <p className="mt-6 max-w-2xl text-base leading-7 text-[#aeb7ba] sm:text-lg">
              Understand how NEXUS AI maintains conversation context, stores
              useful information, and uses memory as part of its LangGraph
              workflow.
            </p>
          </div>
        </div>
